...
The RexToken contract below was deployed to [0x99d439455991f7f4885f20c634c9a31918d366e5](https://etherscan.io/address/0x99d439455991f7f4885f20c634c9a31918d366e5#code)
with an incorrect `vault` address sent in the deployment parameters.

Following is the RexToken constructor code:
```javascript
...
Instead of specifying the `vault` address of [0x03e4b00b607d09811b0fa61cf636a6460861939f](https://etherscan.io/address/0x03e4b00b607d09811b0fa61cf636a6460861939f)
the address was copy and pasted as [0x3e4b00b607d0980668ca6e50201576b00000000](https://etherscan.io/address/0x3e4b00b607d0980668ca6e50201576b00000000) and can be seen in the deployment parameters:

```
00000000000000000000000000000000000000000000000000000000597f540000000000000000000000000003e4b00b607d0980668ca6e50201576b00000000

-----Decoded View---------------
Found 2 constructor arguments :
Arg [0] : 00000000000000000000000000000000000000000000000000000000597f5400
Arg [1] : 00000000000000000000000003e4b00b607d0980668ca6e50201576b00000000
```
